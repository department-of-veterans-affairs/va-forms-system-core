...
describe('Routing - Router Context', () => {
  ...
  test('Router Context passes correct route information to the progress bar', async () => {
    ...
    await waitFor(() =>
      ...
      ).toContain('Step 1 of 2: Page One')
    );
  });
  ...
  test('Router Context passes correct conditional route information to the progress bar', async () => {
    ...
    const { container } = render(
      <MemoryRouter initialEntries={routes} initialIndex={1}>
        ...
        >
          ...
          <Route path="/page-two" element={<PageTwo title="Page Two" />} />
          <Route
            path="/page-two-conditional"
            element={
              <ConditionalRoute
                title="Page Two Conditional"
                type="conditional"
    ...
    await waitFor(() =>
      expect(
        container.querySelector('h2.vads-u-font-size--h4')?.innerHTML
      ).toContain('Step 1 of 2: Page Two')
    );
  });
  ...
  test('Landing on enabled Conditional Route Renders child element', async () => {
    ...
    await waitFor(() =>
      expect(
        container.querySelector('h2.vads-u-font-size--h4')?.innerHTML
      ).toContain('Step 2 of 2: Page Two Conditional')
    );
  });
  ...
  test('Landing on disabled Conditional Route Renders next viable route', async () => {
    ...
    const { container } = render(
      <MemoryRouter initialEntries={routes} initialIndex={2}>
        ...
        >
          ...
          />
          <Route
            path="/page-two-point-five-conditional"
            element={
              <ConditionalRoute
                title="Page Two Point Five Conditional"
                type="conditional"
                condition={'conditionalFalse'}
              >
    ...
    await waitFor(() =>
      expect(
        container.querySelector('h2.vads-u-font-size--h4')?.innerHTML
      ).toContain('Step 1 of 1: Page Three')
    );
  });
});
