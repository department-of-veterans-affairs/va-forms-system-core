...
const OMBInfo = (props: OMBInfoProps): JSX.Element => {
  ...
  // const modalContents = (minutes, benefitType) => (
  //   <div>
  //     <h3 id={`${props.id}-title`}>Privacy Act Statement</h3>
  //     {minutes && (
  //       <p>
  ...
  const { resBurden, benefitType, ombNumber, expDate } = props;
  ...
  return (
    <div className="omb-info">
      ...
      {/* <div>
        <button className="va-button-link" onClick={openModal}>
